...
[Story(
    ...
    IWant = "to be able to create wallets with categories and items",
...
public class CreateItemTests : IClassFixture<AuthFixture>
{
    ...
    [Fact]
    public void Create_item_for_wallet()
    {
        this.Given(step => fixture.GivenAUser())
            .And(step => itemSteps.GivenIHaveSpecfiedAFullItem())
            .When(step => itemSteps.WhenICreateTheItemForAnExistingWalletAndCategory())
