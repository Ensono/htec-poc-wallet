...
using HTEC.Engagement.API.ContractTests.Fixtures;
using HTEC.Engagement.Infrastructure;

namespace HTEC.Engagement.API.ContractTests
{
    public class PointsApiProviderTests
    {
        private string ProviderUri { get; }
        private ITestOutputHelper OutputHelper { get; }

        private readonly ConfigModel Config;
        private const string ProviderName = "PointsAPI";
        private readonly PactVerifierConfig PactConfig;

        public PointsApiProviderTests(ITestOutputHelper output)
        {
            OutputHelper = output;
