...
using HTEC.Engagement.API.Authorization;
using HTEC.Engagement.API.Models.Requests;

namespace HTEC.Engagement.API
{
    public class Startup
    {
            ...
            IOptions<JwtBearerAuthenticationConfiguration> jwtBearerAuthenticationOptions)
        {
            ...
            .UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("all/swagger.json", "Points (all)");
                c.SwaggerEndpoint("v1/swagger.json", "Points (version 1)");
                c.SwaggerEndpoint("v2/swagger.json", "Points (version 2)");
            ...
            services
                ...
                .AddSwaggerGen(c =>
                {
                    c.SwaggerDoc("all", new OpenApiInfo
                    {
                        Version = "all",
                        Title = "Points API",
                        Description = "APIs used to interact and manage pointss for a restaurant",
                    ...
                    c.IncludeXmlComments($"{AppContext.BaseDirectory}{Path.DirectorySeparatorChar}{typeof(CreatePointsRequest).Assembly.GetName().Name}.xml");
