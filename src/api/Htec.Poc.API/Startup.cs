        ...
        IOptions<JwtBearerAuthenticationConfiguration> jwtBearerAuthenticationOptions)
    {
        ...
        app
            ...
            .UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("all/swagger.json", "Wallet (all)");
                c.SwaggerEndpoint("v1/swagger.json", "Wallet (version 1)");
                c.SwaggerEndpoint("v2/swagger.json", "Wallet (version 2)");
        ...
        services
            ...
            .AddSwaggerGen(c =>
            {
                c.SwaggerDoc("all", new OpenApiInfo
                {
                    Version = "all",
                    Title = "Wallet API",
                    Description = "APIs used to interact and manage wallets for a restaurant",
                ...
                c.IncludeXmlComments(
                    $"{AppContext.BaseDirectory}{Path.DirectorySeparatorChar}{typeof(CreateWalletRequest).Assembly.GetName().Name}.xml");
