...
using Shouldly;
using Xunit;
using HTEC.Engagement.Common.Events;
...
namespace HTEC.Engagement.CQRS.UnitTests
{
    ...
    public class EventsTests
    {
        ...
        {
            var assembly = typeof(PointsCreatedEvent).Assembly;
        ...
        {
            var definitions = typeof(PointsCreatedEvent).Assembly.GetImplementationsOf(typeof(IApplicationEvent));
