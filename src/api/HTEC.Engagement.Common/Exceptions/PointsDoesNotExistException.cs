...
{
    [Serializable]
    public class PointsDoesNotExistException : ApplicationExceptionBase
    {
        private PointsDoesNotExistException(
        ...
        {
            var exception = new PointsDoesNotExistException(
                Exceptions.ExceptionCode.PointsDoesNotExist,
                operationCode,
                correlationId,
                message ?? $"A points with id '{pointsId}' does not exist."
            );
