...
public abstract class ApiClientFixture : ApiFixture<Startup>
{
    ...
    /// <summary>
    /// Send a POST Http request to the API CreateWallet endpoint passing the wallet being created
    /// </summary>
    /// <param name="wallet">Wallet being created</param>
    public async Task<HttpResponseMessage> CreateWallet(CreateWalletRequest wallet)
    {
