...
using Serilog;
using HTEC.Engagement.BackgroundWorker.Handlers;

namespace HTEC.Engagement.BackgroundWorker
{
		...
		public static IHostBuilder CreateWebHostBuilder(string[] args) =>
			Host.CreateDefaultBuilder(args)
				...
				.ConfigureServices((hostContext, services) =>
				{
					...
					var definitions = typeof(PointsCreatedEventHandler).Assembly.GetImplementationsOf(typeof(IApplicationEventHandler<>));
