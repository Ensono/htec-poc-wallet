...
namespace HTEC.Engagement.Application.CQRS.Events
{
	...
	{
		[JsonConstructor]
		public CategoryCreatedEvent(int operationCode, Guid correlationId, Guid pointsId, Guid categoryId)
		{
		...
		public CategoryCreatedEvent(IOperationContext context, Guid pointsId, Guid categoryId)
		{
